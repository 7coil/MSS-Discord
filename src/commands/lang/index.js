...
module.exports = function (message) {
	...
	if(!data.languages.some((element)=>{return element == message.data.lang})) return message.reply(meta[message.data.lang] && meta[message.data.lang].err_not_found || "err_not_found");
